...
export default function NewJobPage() {
  ...
  if (!company) {
    router.push(orgSlug ? `/orgs/${orgSlug}/dashboard` : "/company/new");
    return null;
  }
      ...
      >
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            placeholder="Day-to-day responsibilities and tasks..."
          />
        </div>
        ...
        <div className="pt-4 border-t border-gray-200 flex gap-3">
          ...
          >
            {submitting ? "Publishing..." : status === "draft" ? "Save Draft" : "Publish Job"}
          </button>
          <button
            type="button"
            onClick={() => router.back()}
